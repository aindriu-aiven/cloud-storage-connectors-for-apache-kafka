...
/**
 * This code was originally developed as part of the Apache RAT project
...
public final class VersionInfo {
    ...
    public static void main(final String[] args) {
        ...
        System.out.println("title: " + Version.getTitle());
        System.out.println("version: " + Version.getVersion());
        System.out.println("vendor: " + Version.getVendor());
        System.out.println("spec title: " + Version.getSpecTitle());
        System.out.println("spec version: " + Version.getSpecVersion());
        System.out.println("spec vendor: " + Version.getSpecVendor());
    }
    ...
    /**
     * Constructor that uses the Version package for information.
     */
    public VersionInfo() {
