...
public class AzureBlobSourceTask extends AbstractSourceTask {
    ...
    /**
     * The Configuration for the Azure blob source connector
     */
    private AzureBlobSourceConfig azureBlobSourceConfig; // NOPMD unused variable remove PMD warning when used
